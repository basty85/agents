...
class StockPickerSelf():
    ...
    def trending_company_finder(self) -> Agent:
        return Agent(config=self.agents_config['trending_company_finder'], llm=self.searcher_picker_llm, tools=[SerperDevTool()])
    ...
    def stock_picker(self) -> Agent:
        return Agent(config=self.agents_config['stock_picker'], llm=self.searcher_picker_llm, tools=[PushNotificationTool()])
